    ...
    describe('UserApp Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a UserApp', () => {
                service.create(new UserApp(null)).subscribe(received => {
            ...
            it('should update a UserApp', () => {
                service.update(new UserApp(123)).subscribe(received => {
