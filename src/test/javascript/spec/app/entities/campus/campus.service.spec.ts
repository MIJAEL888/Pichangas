...
describe('Service Tests', () => {
    describe('Campus Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CampusService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/campuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Campus', () => {
                service.create(new Campus(null)).subscribe(received => {
            ...
            it('should update a Campus', () => {
                service.update(new Campus(123)).subscribe(received => {
