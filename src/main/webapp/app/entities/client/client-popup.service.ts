            ...
            if (id) {
                this.clientService.find(id)
                    .subscribe((clientResponse: HttpResponse<Client>) => {
                        ...
                        if (client.dateSuscription) {
                            client.dateSuscription = {
                                year: client.dateSuscription.getFullYear(),
                                month: client.dateSuscription.getMonth() + 1,
                                day: client.dateSuscription.getDate()
                            };
                        }
